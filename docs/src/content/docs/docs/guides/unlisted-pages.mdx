...
This is done by including the content page in a [topic sidebar configuration](http://localhost:4321/docs/configuration#items) and the plugin will automatically determine which sidebar to display based on the current page.
